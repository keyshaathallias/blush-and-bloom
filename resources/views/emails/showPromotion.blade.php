  ...
  <div class="mb-0 page-heading">
    <div class="container-fluid">
      <nav aria-label="breadcrumb" class="breadcrumb-header float-start">
        <ol class="breadcrumb">
          <li class="breadcrumb-item" aria-current="page"><a href="">Email Message</a></li>
        </ol>
      </nav>
    </div>
  </div>
  <div class="page-content">
    <!-- Table Data Email Message -->
            ...
            <div class="flex flex-wrap card-header">
              ...
              <div class="order-last col-12 col-md-6 order-md-2">
                <div class="float-start float-lg-end">
                  <a href="{{ route('email.edit', $email->id) }}" class="float-right m-auto btn btn-primary">Edit Email
                    Message</a>
                </div>
              </div>
            </div>
                        ...
                        <style type="text/css">
                          ...
                          @media only screen and (max-width:600px) {
                            ...
                            *[class="gmail-fix"] {
                            ...
                            .es-text-1589 .es-text-mobile-size-28,
                            .es-text-1589 .es-text-mobile-size-28 * {
                              font-size: 28px !important;
                              line-height: 150% !important
                            }

                            .es-text-7862 .es-text-mobile-size-16,
                            .es-text-7862 .es-text-mobile-size-16 * {
                              font-size: 16px !important;
                              line-height: 150% !important
                            }

                            .es-text-9855 .es-text-mobile-size-16,
                            .es-text-9855 .es-text-mobile-size-16 * {
                              font-size: 16px !important;
                              line-height: 150% !important
                            }

                            .es-text-2370 .es-text-mobile-size-16,
                            .es-text-2370 .es-text-mobile-size-16 * {
                              font-size: 16px !important;
                              line-height: 150% !important
                            }
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <td align="center" style="padding:0;Margin:0;font-size:0">
                                                                  <img alt="" width="560"
                                                                    src="https://eprtutf.stripocdn.email/content/guids/CABINET_228d9e27d9d0cf8576c371d2e21b720ed90ba291d1808f5235c7944bdb04a390/images/header.png"
                                                                    class="adapt-img"
                                                      ...
                                                      <tr>
                                                        <td valign="top" align="center"
                                                          ...
                                                          <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <td align="center" class="es-text-1589"
                                                      ...
                                                      <tr>
                                                        <td align="left" style="padding:0;Margin:0;width:560px">
                                                          <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tbody>
                                                              <tr>
                                                                <td align="center" class="es-text-7862"
                                                                  style="padding:0;Margin:0">
                                                                  <p class="es-text-mobile-size-16"
                                                                    ...
                                                                    Dear <strong>(Customer's Name),</strong>
                                                                    {!! $email->body !!}</p>
                                                                </td>
                                                              </tr>
                                                            </tbody>
                                                              ...
                                                              <tr>
                                                                <td align="center"
                                                                  style="padding:0;Margin:0;font-size:0"><img
                                                                    alt="" width="560"
                                                                    src="https://eprtutf.stripocdn.email/content/guids/CABINET_228d9e27d9d0cf8576c371d2e21b720ed90ba291d1808f5235c7944bdb04a390/images/footer_bnb.png"
                                                                    class="adapt-img"
                                                                    style="display:block;font-size:14px;border:0;outline:none;text-decoration:none">
                                                                </td>
                                                              </tr>

...
<body class="font-poppins bg-light">
    ...
    <div class="block ml-5 lg:hidden">
      <svg id="hamburger" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#493628" class="bi bi-list"
        viewBox="0 0 16 16">
        ...
        <form action="{{ route('login.login') }}" method="POST" class="lg:w-[550px] w-[350px]">
            ...
            <div class="relative pt-8">
              <input type="email" name="email" id="email"
                class="w-full px-6 py-2 bg-white border border-cream rounded-xl"
